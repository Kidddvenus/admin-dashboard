...
class MembersFormScreen extends StatefulWidget {
  @override
  _MembersFormScreenState createState() => _MembersFormScreenState();
}

class _MembersFormScreenState extends State<MembersFormScreen> {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField('Department (optional)', _departmentController),
                    _buildTextField('Phone', _phoneController),
                    _buildTextField('Cell (optional)', _cellController),
